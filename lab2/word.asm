...
table:     .word    -1, 2, 3, -10, 20, 30, -100, 200, 300
table_len: .byte    9

.text
# Sum the table of words
#   $t0 - Length of table
#   $t1 - Ptr to table1
#   $t2 - Counter
#   $t3 - 
...
Loop1: lw $t4, 0($t1)            # Load value at address t1 into t4
       add $t5, $t4, $t5         # Add value of t4 to running sum (t5)
       add $t1, 0x4              # Increment pointer by sizeof(word)=4
